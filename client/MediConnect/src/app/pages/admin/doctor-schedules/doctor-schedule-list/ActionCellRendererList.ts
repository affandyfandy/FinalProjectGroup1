...
import { DoctorScheduleModalComponent } from '../doctor-schedule-modal/doctor-schedule-modal.component';
    ...
    <hlm-dialog>
      ...
      >
        <hlm-dialog-header class="w-full text-left">
          <h3 hlmDialogTitle>Schedule Information</h3>
